class Language {
  ...
  static String descriptionOfAdministrator = 'The top role of this organization';
  static String descriptionOfRDManager = 'The manager of Research and Development department';
  static String descriptionOfSoftwareEngineer = 'A Software Engineer of Research and Development department';
  static String descriptionOfHardwareEngineer = 'A Hardware Engineer of Research and Development department';
  static String descriptionOfFinanceManger = 'The manager of Finance Department';
  static String descriptionOfPurchasingSpecialist = 'A Purchasing Specialist of Finance Department';
  static String descriptionOfAccountingSpecialist = 'A Accounting Specialist of Finance Department';
  static String descriptionOfHRManger = 'The manager of Human Resources Department';
  static String descriptionOfHRSpecialist = 'A Human Resources Specialist of Human Resources Department';
  static String descriptionOfMarketingManger = 'The manager of Marketing Department';
  ...
  static String pressToAddCoverImage = 'press to add cover image';
  static String pressToAddFirstImage = 'press to add first image';
  static String pressToAddSecondImage = 'press to add second image';
  static String pressToAddThirdImage = 'press to add third image';
  static String pressToAddFourthImage = 'press to add fourth image';
  static String pressToAddFifthImage = 'press to add fifth image';
  static String pressToModifyCoverImage = 'press to modify cover image';
  static String pressToModifyFirstImage = 'press to modify first image';
  static String pressToModifySecondImage = 'press to modify second image';
  static String pressToModifyThirdImage = 'press to modify third image';
  static String pressToModifyFourthImage = 'press to modify fourth image';
  static String pressToModifyFifthImage = 'press to modify fifth image';
  static String pressRightButtonToAddCoverImage = 'press the right button to add cover image';
  static String pressRightButtonToAddFirstImage = 'press the right button to add first image';
  static String pressRightButtonToAddSecondImage = 'press the right button to add second image';
  static String pressRightButtonToAddThirdImage = 'press the right button to add third image';
  static String pressRightButtonToAddFourthImage = 'press the right button to add fourth image';
